...
# Allow a frontend URL from environment (e.g., Render/Vercel deployments)
frontend_origin = os.environ.get("FRONTEND_URL")
if frontend_origin:
    allowed_origins.append(frontend_origin)
else:
    # Fallback to common deployed frontend domain if FRONTEND_URL is not provided
    allowed_origins.append("https://vcare-app.vercel.app")
